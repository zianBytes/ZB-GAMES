...
// include: /var/folders/z7/px6_wxg52sgg_m_7fkx8fqh40000gn/T/tmpwg3kg_lo.js
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/.DS_Store", "start": 0, "end": 6148}, {"filename": "/assets/TobyNew.png", "start": 6148, "end": 8526}, {"filename": "/assets/TobySpaceship.png", "start": 8526, "end": 11027}, {"filename": "/assets/background.png", "start": 11027, "end": 39808}, {"filename": "/assets/buttonPress.mp3", "start": 39808, "end": 55690, "audio": 1}, {"filename": "/assets/crash.mp3", "start": 55690, "end": 93130, "audio": 1}, {"filename": "/assets/gameOver.mp3", "start": 93130, "end": 217546, "audio": 1}, {"filename": "/assets/gamePage.mp3", "start": 217546, "end": 1510858, "audio": 1}, {"filename": "/assets/lobby.mp3", "start": 1510858, "end": 4614622, "audio": 1}, {"filename": "/assets/shader_webgl.fs", "start": 4614622, "end": 4614789}, {"filename": "/assets/shader_webgl.vs", "start": 4614789, "end": 4615042}, {"filename": "/assets/spaceCraft.mp3", "start": 4615042, "end": 5247106, "audio": 1}, {"filename": "/assets/toby_in_spaceship-sprite.png", "start": 5247106, "end": 5249124}], "remote_package_size": 5249124});

  })();

// end include: /var/folders/z7/px6_wxg52sgg_m_7fkx8fqh40000gn/T/tmpwg3kg_lo.js
// include: /var/folders/z7/px6_wxg52sgg_m_7fkx8fqh40000gn/T/tmptfo0k_te.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/z7/px6_wxg52sgg_m_7fkx8fqh40000gn/T/tmptfo0k_te.js
// include: /var/folders/z7/px6_wxg52sgg_m_7fkx8fqh40000gn/T/tmpr8no196d.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/z7/px6_wxg52sgg_m_7fkx8fqh40000gn/T/tmpr8no196d.js
...
var ASM_CONSTS = {
  1118040: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 1120218: () => { if (typeof(window.miniaudio) !== 'undefined') { miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 1120508: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 1120612: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 1120783: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 1123660: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 1123733: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 1124133: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 1124183: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 1124322: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 1124462: () => { if (document.fullscreenElement) return 1; },  
 1124508: () => { return Module.canvas.width; },  
 1124540: () => { return parseInt(Module.canvas.style.width); },  
 1124588: () => { document.exitFullscreen(); },  
 1124615: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1124688: () => { if (document.fullscreenElement) return 1; },  
 1124734: () => { return Module.canvas.width; },  
 1124766: () => { return screen.width; },  
 1124791: () => { document.exitFullscreen(); },  
 1124818: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1124951: () => { return window.innerWidth; },  
 1124977: () => { return window.innerHeight; },  
 1125004: () => { if (document.fullscreenElement) return 1; },  
 1125050: () => { return Module.canvas.width; },  
 1125082: () => { return parseInt(Module.canvas.style.width); },  
 1125130: () => { if (document.fullscreenElement) return 1; },  
 1125176: () => { return Module.canvas.width; },  
 1125208: () => { return screen.width; },  
 1125233: () => { return window.innerWidth; },  
 1125259: () => { return window.innerHeight; },  
 1125286: () => { if (document.fullscreenElement) return 1; },  
 1125332: () => { return Module.canvas.width; },  
 1125364: () => { return screen.width; },  
 1125389: () => { document.exitFullscreen(); },  
 1125416: () => { if (document.fullscreenElement) return 1; },  
 1125462: () => { return Module.canvas.width; },  
 1125494: () => { return parseInt(Module.canvas.style.width); },  
 1125542: () => { document.exitFullscreen(); },  
 1125569: ($0) => { Module.canvas.style.opacity = $0; },  
 1125607: () => { return screen.width; },  
 1125632: () => { return screen.height; },  
 1125658: () => { return window.screenX; },  
 1125685: () => { return window.screenY; },  
 1125712: () => { return window.devicePixelRatio; },  
 1125748: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1125801: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1125852: () => { Module.canvas.style.cursor = 'none'; },  
 1125889: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1126145: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1126196: () => { if (document.fullscreenElement) return 1; },  
 1126242: () => { return window.innerWidth; },  
 1126268: () => { return window.innerHeight; },  
 1126295: () => { if (document.pointerLockElement) return 1; }
};
